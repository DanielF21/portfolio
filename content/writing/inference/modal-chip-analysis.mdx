---
title: "Modal GPU candidates"
publishedAt: "2026-08-08"
series: "inference"
summary: "Why the A10, weighed against the L4 and the rest of the fleet."
---
...
- The T4's 65 TFLOPS is quoted by NVIDIA as "mixed precision (FP16/FP32)" —
  FP16 multiply with FP32 accumulate, the same operation the other rows list
  as FP16 Tensor Core.
- **A100 40GB** exists in SXM4 and PCIe forms, both 1,555 GB/s at 40 GB.
- **L40S / L4 / A10 are GDDR6, not HBM.**
- FP32 column is the non-tensor-core CUDA-core rate; fp16/bf16 inference uses
