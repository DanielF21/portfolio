...
description: "The full FLOP and byte counts behind the MFU and MBU tables in this series, derived from Qwen2.5-1.5B's architecture and one measured quantity per engine."
series: "inference"
